...
/*Una escuela ha terminado su ciclo lectivo y todos sus alumnos ya rindieron 
    el examen final. La escuela nos ha pedido que calculemos el promedio de
    notas final de todos sus alumnos y saber qué alumnos han recibido una
...
Por último, deberemos mostrar todos los estudiantes con una nota mayor 
    al promedio.
...
*/
    ...
    public static void main(String[] args) {
        ...
        Alumno [] cursito2 = service.crearCurso();
        
        service.mostrar(cursito2);
        
        service.calularProm(cursito2);
        
        service.mostrar( service.aprobados(cursito2, service.calularProm(cursito2)));
